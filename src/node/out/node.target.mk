...
$(OBJS): | $(obj).host/node_js2c.stamp $(builddir)/libopenssl.a $(obj).target/node_dtrace_header.stamp $(obj).target/deps/v8/tools/gyp/postmortem-metadata.stamp $(obj).target/deps/v8/tools/gyp/v8.stamp $(builddir)/libchrome_zlib.a $(builddir)/libhttp_parser.a $(builddir)/libcares.a $(builddir)/libuv.a $(builddir)/libv8_base.x64.a $(builddir)/libv8_snapshot.a $(obj).target/deps/v8/tools/gyp/js2c.stamp $(obj).target/deps/uv/uv_dtrace_header.stamp
...
$(builddir)/node: LD_INPUTS := $(OBJS) $(builddir)/libopenssl.a $(builddir)/libchrome_zlib.a $(builddir)/libhttp_parser.a $(builddir)/libcares.a $(builddir)/libuv.a $(builddir)/libv8_base.x64.a $(builddir)/libv8_snapshot.a
$(builddir)/node: TOOLSET := $(TOOLSET)
$(builddir)/node: $(OBJS) $(builddir)/libopenssl.a $(builddir)/libchrome_zlib.a $(builddir)/libhttp_parser.a $(builddir)/libcares.a $(builddir)/libuv.a $(builddir)/libv8_base.x64.a $(builddir)/libv8_snapshot.a FORCE_DO_CMD
	$(call do_cmd,link)
