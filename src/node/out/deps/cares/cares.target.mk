...
INCS_Debug := \
	...
	-I$(srcdir)/deps/cares/config/darwin
...
OBJS := \
	...
	$(obj).target/$(TARGET)/deps/cares/src/windows_port.o
...
$(builddir)/libcares.a: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/libcares.a: LIBS := $(LIBS)
$(builddir)/libcares.a: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/libcares.a: TOOLSET := $(TOOLSET)
$(builddir)/libcares.a: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,alink)
