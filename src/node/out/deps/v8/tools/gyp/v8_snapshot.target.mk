...
quiet_cmd__Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION _Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot $@
cmd__Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/deps/v8/tools/gyp; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot.x64" --log-snapshot-positions --logfile "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.log" "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc"
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: $(builddir)/mksnapshot.x64 FORCE_DO_CMD
	$(call do_cmd,_Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
action__Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
...
$(OBJS): | $(builddir)/mksnapshot.x64 $(obj).target/deps/v8/tools/gyp/js2c.stamp

# Make sure our actions/rules run before any of us.
$(OBJS): | $(action__Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(builddir)/libv8_snapshot.a: | $(action__Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__Users_samcaldwell_Desktop_git_nemesis_src_node_deps_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(builddir)/mksnapshot.x64 $(obj).target/deps/v8/tools/gyp/js2c.stamp
